...
from eval_common import load_json, minimal_child_environment, observed_fields, replace_tokens, resolve_adapter_path, sha256_bytes, sha256_file, write_json
...
def run(
    ...
    holytail_match = None
    if expected["holytail_expected"] != "NOT_APPLICABLE":
        holytail_match = holytail == expected["holytail_expected"]
    result = {
